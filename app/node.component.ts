...
export class NodeComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    const { id } = this.node;
    this.jsPlumbInstance.addEndpoint(id, { anchor: 'ContinuousBottom', uuid: id + '_bottom1' }, Endpoint1);
    this.jsPlumbInstance.addEndpoint(id, { anchor: 'ContinuousBottom', uuid: id + '_bottom2' }, Endpoint1);
